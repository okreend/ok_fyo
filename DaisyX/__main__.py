...
buttons = [
    ...
    [
        InlineKeyboardButton(text="🕵️‍♀️ Help & Commands 🕵️‍♀️", callback_data="help_back"),
    ],
    [
        InlineKeyboardButton(
...
HELP_STRINGS = f"""
*Hey there!:* [👸](https://telegra.ph/file/28f00f2aac0c888cf2713.jpg)
...
def DaisyX_about_callback(update, context):
    ...
    if query.data == "aboutmanu_":
        query.message.edit_text(
            text=f"*Hello Sir!  The name's {dispatcher.bot.first_name} 👸 \n\n  I'm a next generational group management bot developed by my owner..* "
            f"\n\n- Join [FyonaSupport](https://t.me/FyonaSupport) For help related to {dispatcher.bot.first_name} "
            f"\n\n- I have the advanced and handy Antispam system and the SIBYL banning system which safegaurds and helps your group from spammers."
            f"\n\nI Can Manage Your Groups Smoothly, With Some Special Features [:)](https://telegra.ph/file/28f00f2aac0c888cf2713.jpg)"
            f"\n\n✪ For Knowig More About Me click The Below Buttons",
            parse_mode=ParseMode.MARKDOWN,
        ...
        query.message.edit_text(
            ...
            f"\n\nYou Can get support {dispatcher.bot.first_name} by joining [Fyona Support](https://t.me/FyonaSupport).\n"
            f"",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
        ...
        query.message.edit_text(
            text=f"*{dispatcher.bot.first_name} Is tcreated with love in india for the best performance ❤.*"
...
def get_help(update, context):
    ...
    if chat.type != chat.PRIVATE:
        if len(args) >= 2 and any(args[1].lower() == x for x in HELPABLE):
            module = args[1].lower()
            update.effective_message.reply_text(
                f"👩‍💻Catch me in PM to get help of {module.capitalize()}",
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
